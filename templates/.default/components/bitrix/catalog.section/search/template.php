											...
											<? foreach ($arElement["PRICES"] as $code => $arPrice): ?>
												<? if ($arPrice["CAN_ACCESS"]): ?>
													<? if ($arPrice["DISCOUNT_VALUE"] < $arPrice["VALUE"]): ?>
														<span class="catalog-item__price-old"><?= $arPrice["VALUE"] ?>
															₽</span>
														<span class="catalog-item__price-main"><?= $arPrice["DISCOUNT_VALUE"] ?>
															₽</span>
													<? else: ?>
														<span class="catalog-item__price-main"><?= $arPrice["VALUE"] ?>
															₽</span>
													<? endif; ?>
												<? endif; ?>
											<? endforeach; ?>

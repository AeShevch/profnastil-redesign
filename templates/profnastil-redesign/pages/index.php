        ...
        <div class="partners__inner row">
            ...
            if (CModule::IncludeModule("iblock")):
                ...
                $partners = CIBlockElement::GetList(
                    ...
                    array("NAME", "PROPERTY_PARTNER_URL","PROPERTY_PARTNER_IMG")
                );

                while ($ar_fields = $partners->GetNext()){
                    $img_path = CFile::GetPath($ar_fields['PROPERTY_PARTNER_IMG_VALUE']);
                    $partner_url=$ar_fields['PROPERTY_PARTNER_URL_VALUE']; ?>

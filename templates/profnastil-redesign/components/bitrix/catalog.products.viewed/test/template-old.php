                    ...
                    <li class="col-6 col-lg p-0"
                        ...
                        <article class="catalog-item">
                            ...
                            <div class="catalog-item__control-buttons">
                                <button class="product-control" aria-label="Добавить товар в избранное" title="Добавить товар в избранное" type="button">
                                    <svg aria-hidden="true" width="20" height="20">
                                        <use xlink:href="#icon_like"></use>
                                    </svg>
                                </button>
                                <button class="product-control" aria-label="Добавить товар в сравнение" title="Добавить товар в сравнение" type="button">
                                    <svg aria-hidden="true" width="20" height="20">
